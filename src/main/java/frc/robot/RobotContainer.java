...
import frc.robot.commands.actions.climb.DeployClimb;
...
public class RobotContainer
{
  ...
  public static void setMode(RobotStates mode) {
    if (mode == RobotStates.CLIMB) {
      Command deploy = new ParallelCommandGroup(new InstantCommand(() -> instance.endeffector.setSetpoint(0)), new InstantCommand(() -> instance.elevator.setSetpoint(0)), new DeployClimb(instance.climb));
      deploy.schedule();
    }
    currentMode = mode;
  }
