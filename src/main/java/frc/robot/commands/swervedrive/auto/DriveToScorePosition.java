 ...
 */
public class DriveToScorePosition extends Command
{
  ...
  public DriveToScorePosition(SwerveSubsystem swerveSubsystem)
  {
  ...
  public void execute()
  {
    selectedPose = swerveSubsystem.getSelectedScorePositionPose();
